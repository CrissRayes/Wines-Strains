...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference("Oenologist.count") do
      post oenologists_url, params: { oenologist: { age: @oenologist.age, company: @oenologist.company, nacionality: @oenologist.nacionality, name: @oenologist.name } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { age: @oenologist.age, company: @oenologist.company, nacionality: @oenologist.nacionality, name: @oenologist.name } }
